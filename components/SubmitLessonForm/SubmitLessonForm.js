...
@connect(({lessons})=>({ initialValues: lessons.get('lesson')}))
@reduxForm({
  form: 'lessonForm'
})
export default class SubmitLessonForm extends Component {
  static propTypes = {
                  ...
                  <div>
                    <div className="form-group">
                      ...
                      <Field name="title" component={title =>
                        <div>
                          <input type="text" {...title} className="form-control" placeholder="Write a title"/>
                          {title.touched && title.error && <span className="text-danger">{title.error}</span>}
                        </div>
                      }/>
                    </div>
                    <div className="form-group">
